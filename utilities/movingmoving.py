"""
movingmoving is a program that takes files from a directory written in a file txt, and copies the file in another new directory
"""
...
#it reads the file in which it is write the directory's images for testing and put the directories in a list
...
#it reads the file in which it is write the directory's annotations for testing and put the directories in a list
